...
public class StringStudy {
    public static void main(String[] args) {
        ...
        System.out.println("str6.substring(3) : " + str6.substring(3));// 파일명에서 확장자 추출할 때 사용

        System.out.println("str6.substring(4, 7) : " + str6.substring(4, 7)); // 4, 5, 6 자리의 문자열을 리턴

        String fileNm = "nice_v.ery.Nice.jpg";
        System.out.println(".의 위치값 : " + fileNm.indexOf("."));
        // 왼쪽에서 오른쪽 방향으로 가장 빨리 찾은 index값을 리턴한다.
