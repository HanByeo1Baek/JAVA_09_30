...
public class Car {
    ...
    /*
        this 사용법은 2가지가 있다.
        1. this.  : 멤버필드, 멤버메소드 사용하고 싶을때, this. 생략가능할 때가 있다.
        2. this() : 생성자에서 다른 생성자 호출시 사용 가능
     */
    public Car(){
      this("white", "auto", 4);
    }
//  ↑ 위처럼 사용 가능, 클래스가 클래스를 불러온 상황
...
//    }
    ...
    public Car(String color, String gearType, int door){
        this.color = color;     // 매개변수명이 멤버필드명과 달랐다면 this.을 생략 가능
    ...
    public void introduce(){
        ...
        // 메소드가 만들어진 시점에서는 객체가 만들어진 상태라 메소드에서 생성자를 호출하는 것은 불가능하다.
...
class CarTest{
    public static void main(String[] args) {
        ...
        c3.introduce();
        //"red 컬러의 manual 기어를 가진 5개의 문짝이 있ㅎ는 자동차"가 표시될 수 있게 해주세요.
